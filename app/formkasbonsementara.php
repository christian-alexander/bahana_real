...
class formkasbonsementara extends Model
{
    use Upload;
    
    protected $table = 'form_kasbon_sementara';
    ...
    public static function store($data, $user_id){
        ...
        try {
            ...
            $counter = formkasbonsementara::count()+1;
            ...
            $no = "$counter/BS/$data_anak_perusahaan3->code-$department3->code/$wilayah3->code/$bulan/$tahun";
            ...
            $model->deadline_ptj = $data['deadline_ptj'];
            $model->note = $data['note'];
            if (isset($data['file']) && !empty($data['file'])) {
                $filename = Files::uploadLocalOrS3($data['file'], "formkasbon-sementara/$user_id");
                $model->image = "user-uploads/formkasbon-sementara/$user_id/$filename";
            }
