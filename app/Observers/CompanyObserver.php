...
class CompanyObserver
{
    ...
    public function addTaskBoard($company)
    {
        ...
        $completeColumn->column_name = 'IN PROGRESS';
        $completeColumn->slug = 'in_progress';
        $completeColumn->label_color = '#ecb652';
        $completeColumn->priority = $uncatColumn->priority + 1;
        $completeColumn->save();

        $completeColumn = new TaskboardColumn();
        $completeColumn->company_id = $company->id;
        $completeColumn->column_name = 'IN REVIEW';
        $completeColumn->slug = 'in_review';
        $completeColumn->label_color = '#af95fc';
        $completeColumn->priority = $uncatColumn->priority + 1;
        $completeColumn->save();

        $completeColumn = new TaskboardColumn();
        $completeColumn->company_id = $company->id;
        $completeColumn->column_name = 'DONE';
    ...
    public function addProjectCategory($company)
    {
        ...
        $category = new \App\ProjectCategory();
        $category->category_name = 'Website';
        $category->company_id = $company->id;
        $category->save();
    }
