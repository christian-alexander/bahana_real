...
class ManageProjectsController extends AdminBaseController
{
    ...
    public function create()
    {
        ...
        $this->wilayah = DB::table('wilayah')->get();
        $this->team = DB::table('teams')->get();
        $this->subcompany = DB::table('sub_company')->get();
    ...
    public function store(StoreProject $request)
    {
        ...
        $project->team_id = \Auth::user()->employeeDetail->department_id;
        ...
        if (isset($request->project_budget) && !empty($request->project_budget)) {
        ...
        if (isset($request->hours_allocated) && !empty($request->hours_allocated)) {
        ...
        $project->alert_late_yellow = $request->alert_kuning;
        $project->alert_late_red = $request->alert_merah;
      
        if (isset($request->subcompany_id) && !empty($request->subcompany_id)) {
            $project->subcompany_id = $request->subcompany_id;
        }
      
        if (isset($request->wilayah_id) && !empty($request->wilayah_id)) {
            $project->wilayah_id = $request->wilayah_id;
        }
    ...
    public function update(StoreProject $request, $id)
    {
        ...
        if (isset($request->feedback) && !empty($request->feedback)) {
