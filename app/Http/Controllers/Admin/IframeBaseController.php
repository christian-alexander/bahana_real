...
class IframeBaseController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(function ($request, $next) {
            ...
            $this->user = DB::table('users')->where('id',$id)->select('*')->first();
            $this->global = $this->company = Company::with('currency', 'package')->withoutGlobalScope('active')->where('id', $this->user->company_id)->first();
            ...
            // $this->user = auth()->user();
          	$this->employee_detail = EmployeeDetails::where('user_id', '=', $this->user->id)->first();
