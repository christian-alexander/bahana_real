...
class MemberKapalController extends MemberBaseController
{
    ...
    public function index()
    {
        ...
        return view('member.office_kapal.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        return view('member.office_kapal.create', $this->data);
    }
    ...
    public function store(StoreRequest $request)
    {
        ...
        return Reply::redirect(route('member.kapal.index'), 'Kapal created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('member.office_kapal.edit', $this->data);
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return Reply::redirect(route('member.kapal.index'), __('messages.updatedSuccessfully'));
    }
