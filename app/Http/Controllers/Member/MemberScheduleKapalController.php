...
class MemberScheduleKapalController extends MemberBaseController
{
    ...
    public function index()
    {
        ...
        return view('member.schedulekapal.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        $this->listEmployee = User::withoutGlobalScope('active')->join('role_user', 'role_user.user_id', '=', 'users.id')
            ...
            ->get();
        return view('member.schedulekapal.create', $this->data);
    }
    ...
    public function store(StoreRequest $request)
    {
        ...
        return Reply::redirect(route('member.schedulekapal.index'), 'Kapal created successfully.');
    }
    ...
    public function edit($id)
    {
        ...
        return view('member.schedulekapal.edit', $this->data);
    }
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return Reply::redirect(route('member.schedulekapal.index'), __('messages.updatedSuccessfully'));
    }
