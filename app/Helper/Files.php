...
class Files
{
    ...
    public static function uploadLocalOrS3($uploadedFile, $dir)
    {
        ...
        //Storage::disk('s3')->putFileAs($dir, $uploadedFile, $newName, 'public');
      	...
      	$nameLocal =  self::upload($uploadedFile, $dir, false, false, false);
      
      	//if (config('filesystems.default') === 's3') {
            // NEED TO UNCOMMENT WHEN READY TO PRODUCTION
            // Storage::disk('s3')->putFileAs($dir, $uploadedFile, $nameLocal, 'public');
        //}
