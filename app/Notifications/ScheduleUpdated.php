...
class ScheduleUpdated extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        ...
        ->line("Ada perubahan meeting " . $this->schedule->subject . " pada tanggal " . $this->schedule->date . " jam " . $this->schedule->time);
    }
    ...
    public function toArray($notifiable)
    {
        ...
        $data['notif']['description'] = "Ada perubahan meeting " . $this->schedule->subject . " pada tanggal " . $this->schedule->date . " jam " . $this->schedule->time;
        $data['notif']['type'] = "Schedule";
        $data['notif']['task_id'] = $this->schedule->id;
    ...
    public function toOneSignal($notifiable)
    {
        ...
        return OneSignalMessage::create()
            ->subject("Invitation meeting")
            ->body("Ada perubahan meeting " . $this->schedule->subject . " pada tanggal " . $this->schedule->date . " jam " . $this->schedule->time)
