...
class CommentOrangKepercayaan extends Notification implements ShouldQueue
{
    ...
    public function via($notifiable)
    {
        ...
        $msg = "Orang kepercayaan anda menambahkan komentar pada tugas ".$this->task->heading;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Orang kepercayaan anda menambahkan komentar pada tugas '.$this->task->heading)
            ->line("Segera periksa notifkasi anda");
    }
    ...
    public function toArray($notifiable)
    {
        ...
        $data['notif']['heading'] = 'Orang kepercayaan anda menambahkan komentar pada tugas '.$this->task->heading;
        $data['notif']['description'] = "Segera periksa notifkasi anda";
        $data['notif']['type'] = "KOMENTAR_ORANG_KEPERCAYAAN";
    ...
    {	
        //big_picture
      	...
      	return OneSignalMessage::create()
              ->subject('Orang kepercayaan anda menambahkan komentar pada tugas '.$this->task->heading)
              ->body("Segera periksa notifkasi anda")
              ->setData("type", "KOMENTAR_ORANG_KEPERCAYAAN")
