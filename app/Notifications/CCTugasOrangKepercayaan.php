...
class CCTugasOrangKepercayaan extends Notification implements ShouldQueue
{
    ...
    public function __construct(Task $task,$notif_to, $type='created')
    {
        $this->type = $type;
        $this->task = $task;
    ...
    public function via($notifiable)
    {
        ...
        if ($this->type=='started') {
            $msg = "Anda sebagain orang kepercayaan di cc pada ".$type." (".$this->task->heading."), ".$type." telah mulai dikerjakan";
        }elseif ($this->type=='stoped') {
            $msg = "Anda sebagain orang kepercayaan di cc pada ".$type." (".$this->task->heading."), ".$type." telah berhenti dikerjakan";
        }else{
            $msg = "Anda sebagain orang kepercayaan di cc pada ".$type." (".$this->task->heading.")";
        }
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ->subject('CC Tugas')
            ->line("Anda sebagain orang kepercayaan di cc pada ".$type);
    }
    ...
    public function toArray($notifiable)
    {
        ...
        $data['notif']['heading'] = "CC ".$type;
        $data['notif']['description'] = "Anda sebagain orang kepercayaan di cc pada ".$type;
        $data['notif']['type'] = "CC_TUGAS";
    ...
    {	
        ...
        if ($this->task->is_meeting==1) {
      	...
      	return OneSignalMessage::create()
              ->subject("CC ".$type)
              ->body("Anda sebagain orang kepercayaan di cc pada ".$type)
              ->setData("type", "CC_TUGAS")
