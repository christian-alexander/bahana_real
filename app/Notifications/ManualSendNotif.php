...
class ManualSendNotif extends Notification implements ShouldQueue
{
    ...
    private $body;
    private $type;
    public function __construct(User $user,$title,$body,$type)
    {
        $this->user = $user;
        $this->title = $title;
        $this->body = $body;
    ...
    public function toArray($notifiable)
    {
        ...
        $data['notif']['heading'] = $this->title;
        $data['notif']['description'] = $this->body;
