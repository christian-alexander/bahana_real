...
class CCTugas extends Notification implements ShouldQueue
{
    ...
    public function via($notifiable)
    {
        ...
        if ($this->type=='started') {
            $msg = "Anda di cc pada ".$type." (".$this->task->heading."), ".$type." telah mulai dikerjakan";
        }elseif ($this->type=='stoped') {
            $msg = "Anda di cc pada ".$type." (".$this->task->heading."), ".$type." telah berhenti dikerjakan";
        }else{
            $msg = "Anda di cc pada ".$type." (".$this->task->heading.")";
        }
    ...
    public function toArray($notifiable)
    {
        ...
        $data['notif']['description'] = "Anda di cc pada ".$type;
