...
return array(
  'setStartHourOffice' => 'Please contact admin, start office and end office has not been set.',
...
After that upload the favicons to public/favicon directory.',
 ...
 will update on select.',
  ...
  'installationWelcome' => ' Welcome to Bahana! Let\'s get you started',
  ...
  'installationCongratulation' => 'Congratulations! You have taken the first step to better managing your bahana',
  ...
  'noCabang' => 'Seems like no branch exist in the database. Create your first branch',
  'noOffice' => 'Seems like no office exist in the database. Create your first office',
  'noPertanyaan' => 'Seems like no question exist in the database. Create your first question',
  'noClusterWorkingHour' => 'Seems like no cluster working hour exist in the database. Create your first cluster working hour',
  'noWilayah' => 'Seems like no region exist in the database. Create your first region',
  'noSubcompany' => 'Seems like no sub-company exist in the database. Create your first sub-company',
  ...
  'errorStartDayReport' => 'Start day report must between 1 - 31'
);
