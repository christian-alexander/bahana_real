...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-6 col-sm-8 col-md-8 col-xs-12 text-right">
            <a href="{{ route('member.schedulekapal.create') }}" class="btn btn-outline btn-success btn-sm">@lang('app.add') {{ __($pageTitle) }} <i class="fa fa-plus" aria-hidden="true"></i></a>
                                ...
                                <td>
                                    ...
                                    <div class="btn-group dropdown m-r-10">
                                        ...
                                        <ul role="menu" class="dropdown-menu pull-right">
                                            <?php /*
                                          	<li><a href="{{ route('member.schedulekapal.edit', [$item->id]) }}"><i class="icon-settings"></i> @lang('app.manage')</a></li>
                                            */ ?>
                                ...
                                <td colspan="5" class="text-center">
                                    <div class="empty-space" style="height: 200px;">
                                        <div class="empty-space-inner">
                                            ...
                                            <div class="subtitle">
                                                <a href="{{ route('member.schedulekapal.create') }}"
            ...
            $('body').on('click', '.sa-params', function(){
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "{{ route('member.schedulekapal.delete',':id') }}";
            ...
            $('body').on('click', '.sa-params2', function(){
                ...
                swal({
                    ...
                    if (isConfirm) {
                        ...
                        var url = "{{ route('member.schedulekapal.approve',':id') }}";
                        url = url.replace(':id', id);
