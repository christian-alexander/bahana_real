...
<div class="white-box">
                        ...
                        @if (!isset($noClockIn))
                            ...
                            @if(!$checkTodayHoliday)
                                {{-- @if($todayTotalClockin < $maxAttandenceInDay) --}}
                                    ...
                                    <div class="col-xs-8 m-t-20">
                                        <label for="">@lang('modules.attendance.your_body_temperature') (<span>&#8451;</span>)</label>
                                        @if(is_null($currenntClockIn))
                                            <input type="text" class="form-control rule-number" id="your_body_temperature" name="your_body_temperature">
                                        @else
                                            <br> {{ $currenntClockIn->your_body_temperature }}
                                        @endif
                                    </div>
                                    <div class="col-xs-8 m-t-20">
                                        <label for="">@lang('modules.attendance.pcr_test')</label>
                                        @if(is_null($currenntClockIn))
                                            <div class="switchery-demo">
                                                @lang('modules.attendance.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="pcr_test" name="pcr_test" /> @lang('modules.attendance.yes')
                                            </div>
                                        @else
                                            <br> {{ $currenntClockIn->is_pcr_test=='1'? trans('modules.attendance.yes'):trans('modules.attendance.no') }}
                                        @endif
                                    </div>
                                    <div class="col-xs-8 m-t-20">
                                        <label for="">@lang('modules.attendance.wash_your_hands_before_work')</label>
                                        @if(is_null($currenntClockIn))
                                            <div class="switchery-demo">
                                                @lang('modules.attendance.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="wash_your_hands_before_work" name="wash_your_hands_before_work"/> @lang('modules.attendance.yes')
                                            </div>
                                        @else
                                        <br> {{ $currenntClockIn->is_wash_your_hands_before_work=='1'? trans('modules.attendance.yes'):trans('modules.attendance.no') }}
                                        @endif
                                    </div>
    ...
    <div class="row" >
        ...
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">Informasi Cuti</div>
                <div class="panel-wrapper collapse in">
                    <div class="panel-body">
                        <table class="table">
                            <thead>
...
<script>
    ...
    $('#clock-in').click(function () {
        ...
        var your_body_temperature = document.getElementById("your_body_temperature").value;
        var pcr_test = document.getElementById("pcr_test").checked;
        var wash_your_hands_before_work = document.getElementById("wash_your_hands_before_work").checked;
        ...
        $.easyAjax({
            ...
            data: {
                ...
                your_body_temperature: your_body_temperature,
                pcr_test: pcr_test,
                wash_your_hands_before_work: wash_your_hands_before_work,
                _token: token
            },
    ...
    $('.show-task-detail').click(function () {
        ...
        $(".rule-number").inputFilter(function(value) {
