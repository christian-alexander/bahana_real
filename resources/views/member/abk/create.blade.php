                            ...
                            <div class="form-body">
                                                    ...
                                                    <option value="{{ $team->id }}">{{ $team->team_name }}</option>
                                                        @if (count($childs)>0)
                                                            @foreach ($childs as $child)
                                                                <option value="{{ $child->id }}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{{ $child->team_name }}</option>
                                                            @endforeach
                                                        @endif
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="cluster_working_hour" id="cluster_working_hour" class="form-control">
                                                ...
                                                @foreach ($cluster_working_hours as $cluster_working_hour)
                                                    <option value="{{$cluster_working_hour->id}}">{{$cluster_working_hour->name}} ({{$cluster_working_hour->type}})</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="switchery-demo">
                                            @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="edit_lat_long" name="edit_lat_long" checked/> @lang('modules.employees.yes')
                                        </div>
                                    </div>
                                </div><br>
