    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12 text-right">
            @if ($user->employeeDetail->is_hrd_kapal==1 || $user->employeeDetail->is_pc == 1)
                <a href="{{ route('member.abk.create') }}" class="btn btn-outline btn-success btn-sm">Tambah ABK <i class="fa fa-plus" aria-hidden="true"></i></a>
            @endif
            <ol class="breadcrumb">
        ...
        $('body').on('click', '.sa-params', function(){
            ...
            swal({
                ...
                if (isConfirm) {
                    ...
                    var url = "{{ route('member.abk.destroy',':id') }}";
...
//                                    swal("Deleted!", response.message, "success");
        ...
        $('body').on('click', '.assign_role', function(){
            ...
            $.easyAjax({
                url: '{{route('member.abk.assignRole')}}',
                type: "POST",
    ...
    function loadTable(){
        ...
        table = $('#users-table').dataTable({
            ...
            serverSide: true,
            destroy: true,
            ajax: '{!! route('member.abk.data') !!}?employee=' + employee+ '&skill=' + skill,
            language: {
