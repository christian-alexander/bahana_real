...
@section('body')
<form class="kt-form" id="form-store" method="POST" action="{{route('formkasbon-sementara.store',$user_id)}}" enctype="multipart/form-data">
    @csrf
    <div class="kt-portlet__body">
        ...
        {{-- <div class="form-group">
            ...
            <select class="form-control kt-select2"  id="kt_select2_1" name="unsur_pph">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="exampleSelect1" name="approval_pajak">
                @foreach ($data_user as $item)
                    <option value="{{$item->id}}">{{$item->name}}</option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            ...
            <select class="form-control kt-select2" id="kt_select2_4" name="disetujui_1">
                @foreach ($data_user as $item)
                    <option value="{{$item->id}}">{{$item->name}}</option>
                @endforeach
            </select>
        ...
        <div class="form-group">
            <label>Deadline PTJ</label>
            <select class="form-control kt-select2" name="deadline_ptj">
                <option value="{{Carbon\Carbon::now()->addDays(14)->format('Y-m-d')}}">
                    {{Carbon\Carbon::now()->addDays(14)->format('Y-m-d')}}
                </option>
                <option value="{{Carbon\Carbon::now()->addDays(30)->format('Y-m-d')}}">
