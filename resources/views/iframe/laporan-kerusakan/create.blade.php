...
@section('body')
<form class="kt-form" id="form-store" method="POST" action="{{route('laporan-kerusakan.store',$user_id)}}">
    @csrf
    <div class="kt-portlet__body">
        ...
        <div class="form-group">
            ...
            <select class="form-control my-select2" id="exampleSelect1" name="nama_kapal">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="bagian_kapal">
