...
<form class="kt-form" method="POST" action="{{route('sounding-bunker-pemakaian-bbm.approve',[$user->id, $data->id])}}">
@csrf
<div class="kt-portlet__body">
    ...
    <div class="form-group">
        <div class="kt-section__info black">Jam</div>
        <div class="kt-section__content">{{$data->jam}}</div>
    </div>
    <div class="form-group">
        <div class="kt-section__info black">rob_awal</div>
        <div class="kt-section__content">{{$data->rob_awal}}</div>
    </div>
    <div class="form-group">
        <div class="kt-section__info black">rob_akhir</div>
        <div class="kt-section__content">{{$data->rob_akhir}}</div>
    </div>
    <div class="form-group">
        <div class="kt-section__info black">port_lokasi</div>
        <div class="kt-section__content">{{$data->port_lokasi}}</div>
    </div>
    ...
    <h4>Pemakaian</h4>
        <table class="table">
            <tr>
                @foreach ($data->pemakaian_json as $key => $val)
                    <td>{{$key}} <b>{{$val}}</b> </td>
                @endforeach
            </tr>
        </table>
...
<form class="kt-form" method="POST" action="{{route('sounding-bunker-pemakaian-bbm.reject',[$user->id, $data->id])}}">
@csrf
<input type="hidden" name="type_approve" value="{{$data->type_approve}}">
<!--begin::Modal reject-->
