...
<form class="kt-form" method="POST" action="{{route('permintaan-dana.approve',[$user->id, $data->id])}}">
@csrf
...
<form class="kt-form" method="POST" action="{{route('permintaan-dana.reject',[$user->id, $data->id])}}">
@csrf
<input type="hidden" name="type_approve" value="{{$data->type_approve}}">
<!--begin::Modal reject-->
