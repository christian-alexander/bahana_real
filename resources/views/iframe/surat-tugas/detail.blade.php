...
<form class="kt-form" method="POST" action="{{route('surat-tugas.approve',[$user->id, $data->id])}}">
@csrf
...
<div class="kt-portlet__foot">
    <div class="kt-form__actions">
        @if ($data->can_approve==1)
            ...
            @else
            <a href="/surat-tugas/detail/{{$user_id}}/{{ $data->id }}/cetak_pdf" class="btn btn-primary" target="_blank">CETAK PDF</a>
        @endif
        @if ($data->can_verif==1)
...
<form class="kt-form" method="POST" action="{{route('surat-tugas.reject',[$user->id, $data->id])}}">
@csrf
<input type="hidden" name="type_approve" value="{{$data->type_approve}}">
<!--begin::Modal reject-->
