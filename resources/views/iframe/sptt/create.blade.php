...
@section('body')
<form class="kt-form" id="form-store" method="POST" action="{{route('sptt.store',$user_id)}}">
    @csrf
    <div class="kt-portlet__body">
        ...
        <div class="form-group">
            ...
            <select class="form-control my-select2" id="exampleSelect1" name="type">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="posisi_kapal">
        ...
        <div class="form-group">
            <label for="exampleSelect1">Diserahkan Oleh</label>
            <select class="form-control my-select2" name="diserahkan_oleh">
                @foreach ($listUser as $key => $item)
                    <option value="{{$key}}">{{$item}}</option>
                @endforeach
            </select>
