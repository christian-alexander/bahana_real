                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="leave-type-table">
                                            ...
                                            @php
                                                if($leaveType->type_name=='Cuti Custom'){
                                                    continue;
                                                }
                                            @endphp
                                                <tr id="type-{{ $leaveType->id }}">
                                                    <td>
                                                        <label class="label label-{{ $leaveType->color }}">{{ ucwords($leaveType->display_name) }}</label>
                                                    </td>
                                                    <td>
                                            ...
                                            @endforelse
                                            @foreach ($tipeCutis as $item)
                                                <tr>
                                                    <td>
                                                        <label class="label label-success">{{ ucwords($item->name) }} (custom)</label>
                                                    </td>
                                                    <td>
                                                        <input type="number" min="0" value="{{ $item->limit }}"
                                                                class="form-control leave-count-{{ $item->id }}">
                                                    </td>
                                                    <td>
                                                        <button type="button" data-type-id="{{ $item->id }}"
                                                                class="btn btn-sm btn-success btn-rounded update-cuti">
                                                            <i class="fa fa-check"></i></button>
                                                    </td>
                                                </tr>
                                            @endforeach
...
@push('footer-script')
    ...
    <script>
        ...
        $('.update-cuti').click(function () {
            var id = $(this).data('type-id');
            var leaves = $('.leave-count-'+id).val();
            var url = "{{ route('admin.tipe-cuti.easyUpdate',':id') }}";
            url = url.replace(':id', id);
