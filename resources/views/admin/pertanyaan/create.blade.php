                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <a href="{{route('admin.pertanyaan.index')}}" class="btn btn-default waves-effect waves-light">@lang('app.back')</a>
                                {!! Form::close() !!}
                            </div>
                        </div>
                    </div>
...
@push('footer-script')
    ...
    <script>
        ...
        $('#save-form').click(function () {
            $.easyAjax({
                url: '{{route('admin.pertanyaan.store')}}',
                container: '#createPertanyaan',
                type: "POST",
                redirect: true,
                data: $('#createPertanyaan').serialize()
            })
        });
    </script>
@endpush
