...
<div class="row">
    ...
    <div class="col-md-7">
        <div class="user-btm-box">
            ...
            <div class="row row-in">
                <div class="col-md-12 row-in-br b-t">
                    <div class="col-in row">
                        <table class="table">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                @foreach ($leave_taken as $key => $item)
                                    <th>{{$item['leave_taken']}}</th>
                                    <th>{{$item['leave_remaining']}}</th>
                                @endforeach
                            </tbody>
                        </table>
                        {{-- @foreach ($leave_taken as $key => $item) --}}
                            {{-- <div class="col-md-6 row-in-br b-t">
                                <div class="col-in row">
                                        <h3 class="box-title">{{$key}} Diambil</h3>
                                        <div class="col-xs-4"><i class="icon-logout text-warning"></i></div>
                                        <div class="col-xs-8 text-right counter">{{ $item['leave_taken'] }}</div>
                                </div>
                            </div>
                            <div class="col-md-6 row-in-br b-t">
                                <div class="col-in row">
                                        <h3 class="box-title">{{$key}} Tersisa</h3>
                                        <div class="col-xs-4"><i class="icon-logout text-warning"></i></div>
                                        <div class="col-xs-8 text-right counter">{{ $item['leave_remaining'] }}</div>
                                </div>
                            </div> --}}
                        {{-- @endforeach --}}
                    </div>
        ...
        <div class="white-box">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="profile">
                    ...
                    <hr>
                    <div class="row">
                        <div class="col-md-6 col-xs-6 b-r"> <strong>@lang('app.subcompany')</strong> <br>
                            <p class="text-muted">{{ (!is_null($employee->employeeDetail) && !is_null($employee->employeeDetail->subcompany)) ? ucwords($employee->employeeDetail->subcompany->name) : 'NA' }}</p>
                        </div>
                        <div class="col-md-6 col-xs-6 b-r"> <strong>@lang('app.cabang')</strong> <br>
                            <p class="text-muted">{{ (!is_null($employee->employeeDetail) && !is_null($employee->employeeDetail->cabang)) ? ucwords($employee->employeeDetail->cabang->name) : 'NA' }}</p>
                        </div>
                        <div class="col-md-6 col-xs-6 b-r"> <strong>@lang('app.wilayah')</strong> <br>
                            <p class="text-muted">{{ (!is_null($employee->employeeDetail) && !is_null($employee->employeeDetail->wilayah)) ? ucwords($employee->employeeDetail->wilayah->name) : 'NA' }}</p>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xs-6 b-r"> <strong>@lang('modules.attendance.officeStartTime')</strong> <br>
                            <p class="text-muted">{{$employeeDetail->office_start_time}}</p>
                        </div>
                        <div class="col-md-6 col-xs-6"> <strong>@lang('modules.attendance.officeEndTime')</strong> <br>
                            <p class="text-muted">{{$employeeDetail->office_end_time}}</p>
                        </div>
                    </div>
                    <hr>
                    <div class="row">
                        <div class="col-md-4 col-xs-4">
                            <strong>@lang('modules.employees.persetujuan_1')</strong><br>
                            <div class="col-md-12 col-xs-12">
                                {{$arr_approval[0]}}
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-4">
                            <strong>@lang('modules.employees.persetujuan_2')</strong><br>
                            <div class="col-md-12 col-xs-12">
                                {{$arr_approval[1]}}
                            </div>
                        </div>
                        <div class="col-md-4 col-xs-4">
                            <strong>@lang('modules.employees.persetujuan_3')</strong><br>
                            <div class="col-md-12 col-xs-12">
                                {{$arr_approval[2]}}
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <?php
                            $subcompany = getPermissionEmployee($employeeDetail->permission)['subcompany'];
                            $wilayah = getPermissionEmployee($employeeDetail->permission)['wilayah'];
                            $cabang = getPermissionEmployee($employeeDetail->permission)['cabang'];
                        ?>
                        <div class="col-md-12 col-xs-12"> <strong>@lang('app.menu.permission')</strong> <br>
                            <div class="col-md-4 col-xs-6">
                                <label>@lang('app.subcompany')</label><br>
                                <ul>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <label>@lang('app.wilayah')</label><br>
                                <ul>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <label>@lang('app.cabang')</label><br>
                                <ul>
