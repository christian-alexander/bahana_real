                    ...
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 ">
                          	...
                          	<div class="col-md-6 ">
                                <div class="form-group">
                                    <label for="">Is admin office?</label>
                                    <div class="switchery-demo">
                                        @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="is_admin_office" name="is_admin_office" {{isset($userDetail->is_admin_office)?($userDetail->is_admin_office == '1'?'checked':''):''}}/> @lang('modules.employees.yes')
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cluster_working_hour" id="cluster_working_hour" class="form-control">
                                        ...
                                        @foreach ($cluster_working_hours as $cluster_working_hour)
                                            <option value="{{$cluster_working_hour->id}}" {{$employeeDetail->cluster_working_hour_id==$cluster_working_hour->id?'selected':''}}>{{$cluster_working_hour->name}} ({{$cluster_working_hour->start_hour}} - {{$cluster_working_hour->end_hour}})</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="col-md-12" style="border: solid 1px #eee;padding:10px;margin-bottom: 15px;">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="switchery-demo">
                                        @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="is_atasan" name="is_atasan" {{isset($employeeDetail->is_atasan)?($employeeDetail->is_atasan=='1'?'checked':''):''}}/> @lang('modules.employees.yes')
                                    </div>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="switchery-demo">
                                        @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="notifikasi_instant" name="notifikasi_instant" {{isset($additional_field->notifikasi_instant)?($additional_field->notifikasi_instant=='1'?'checked':''):''}}/> @lang('modules.employees.yes')
                                    </div>
                                </div>
                            </div><br>
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    @if ($employeeDetail->option_employee==1)
                                        <div id="container_option_employee">
                                    @else
                                                ...
                                                @forelse($subcompanys as $subcompany)
                                                    <div class="checkbox checkbox-inline checkbox-info  col-md-2 m-b-10">
                                                        <?php
                                                            $selected=false;
                                                        ?>
                                                        @foreach ($option_employee_sub_company as $item)
                                                        <?php
                                                            if($item==$subcompany->id){
                                                                $selected=true;
                                                            }
                                                        ...
                                                        <input id="option_employee_subcompany_{{$subcompany->id}}" name="option_employee_subcompany[]" value="{{$subcompany->id}}" type="checkbox" {{$selected?'checked':''}}>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="switchery-demo">
                                        @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="jangan_lacak_saya" name="jangan_lacak_saya" {{isset($additional_field->jangan_lacak_saya)?($additional_field->jangan_lacak_saya=='1'?'checked':''):''}}/> @lang('modules.employees.yes')
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    {{-- <label for="">@lang('modules.employees.reportTask')</label> --}}
                                    <div class="switchery-demo">
                                        @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="akses_delegasi" name="akses_delegasi" {{isset($additional_field->akses_delegasi)?($additional_field->akses_delegasi=='1'?'checked':''):''}}/> @lang('modules.employees.yes')
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 ">
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <label for="">PE</label>
                                        <div class="switchery-demo">
                                            @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="is_pe" name="is_pe" {{isset($employeeDetail->is_pe)?($employeeDetail->is_pe=='1'?'checked':''):''}}/> @lang('modules.employees.yes')
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <div class="switchery-demo">
                                            @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="see_all_project" name="see_all_project" {{isset($additional_field->see_all_project)?($additional_field->see_all_project=='1'?'checked':''):''}}/> @lang('modules.employees.yes')
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="switchery-demo">
                                        @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="is_required_absence" name="is_required_absence" {{isset($additional_field->is_required_absence)?($additional_field->is_required_absence=='1'?'checked':''):'checked'}}/> @lang('modules.employees.yes')
                                    </div>
                                </div>
                            </div><br>
                                ...
                                <div class="col-md-12" style="border: solid 1px #eee;padding:10px;">
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <div class="switchery-demo">
                                                @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="is_nahkoda" name="is_nahkoda" {{isset($additional_field->is_nahkoda)?($additional_field->is_nahkoda=='1'?'checked':''):''}}/> @lang('modules.employees.yes')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <div class="switchery-demo">
                                                @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="is_admin" name="is_admin" {{isset($additional_field->is_admin)?($additional_field->is_admin=='1'?'checked':''):''}}/> @lang('modules.employees.yes')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <div class="switchery-demo">
                                                @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="is_spv_pembelian" name="is_spv_pembelian" {{isset($additional_field->is_spv_pembelian)?($additional_field->is_spv_pembelian=='1'?'checked':''):''}}/> @lang('modules.employees.yes')
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            ...
                                            <div class="switchery-demo">
                                                @lang('modules.employees.no') <input type="checkbox" class="js-switch assign-role-permission" data-size="small" data-color="#00c292" id="is_manager" name="is_manager" {{isset($additional_field->is_manager)?($additional_field->is_manager=='1'?'checked':''):''}}/> @lang('modules.employees.yes')
                                            </div>
                                        </div>
                                    </div>
                                </div>
