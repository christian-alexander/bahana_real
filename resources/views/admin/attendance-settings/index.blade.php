                        ...
                        <div id="vhome3" class="tab-pane active">
                            ...
                            <div class="row">
                                <div class="form-body ">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="start_day_report">@lang('modules.attendance.startDayReport')</label>
                                            <input type="number" class="form-control rule-number" id="start_day_report" name="start_day_report" value="{{$attendanceSetting->start_day_report}}">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="start_day_report">Toleransi Absen Pulang (menit)</label>
                                            <input type="number" class="form-control rule-number" id="toleransi_absen_pulang" name="toleransi_absen_pulang" value="{{$attendanceSetting->toleransi_absen_pulang}}">
                                        </div>
                                    </div>
