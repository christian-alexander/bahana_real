            ...
            <div class="col-md-12">
                ...
                <div class="form-body">
                    <div class="row m-t-30">
                            ...
                            <div class="form-group">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                        <a href="{{ url('user-uploads/screenshot/'.$timeLog->image) }}" target="_blank"><img src="{{ url('user-uploads/screenshot/'.$timeLog->image) }}" alt="" /></a>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="file" name="image" id="imageupdate"> </span>
                        ...
                        @if(isset($project))
                            <div class="col-md-6 " id="editEmployeeBox2">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 " id="editEmployeeBox2">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="user_id" id="user_id_edit">
                                        ...
                                        @forelse($list_member as $member)
                                            <option
                                                    @if($member->id == $timeLog->user_id)
                                                    selected
                                                    @endif
                                                    value="{{ $member->id }}">{{ $member->name }}</option>
                                        @empty
                                            <option value="">No member added to task</option>
                                        @endforelse
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="status" id="status" data-style="form-control">
                                    <option value="in_review" {{$timeLog->status=='in_review'?'selected':''}}>In Review</option>
                                    <option value="accepted" {{$timeLog->status=='accepted'?'selected':''}}>Accepted</option>
                                    <option value="rejected" {{$timeLog->status=='rejected'?'selected':''}}>Rejected</option>
                                </select>
                            </div>
                        </div>
                    </div>
...
//        console.log(hours+" "+minutes);
    ...
    $('#update-form').click(function () {
        $.easyAjax({
            ...
            file: (document.getElementById("imageupdate").files.length == 0) ? false : true,
