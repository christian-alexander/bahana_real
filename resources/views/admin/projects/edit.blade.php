                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-body ">
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <label class="control-label">Anak Perusahaan
                                        </label>
                                        <select class="select2 form-control" name="subcompany_id" id="subcompany_id"
                                                data-style="form-control">
                                            @forelse($subcompany as $w)
                                                <option value="{{ $w->id }}"
                                                        @if($project->subcompany_id == $w->id)
                                                        selected
                                                        @endif
                                                >{{ ucwords($w->name) }}</option>
                                            @empty
                                                <option value="">-</option>
                                            @endforelse
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" name="wilayah_id" id="wilayah_id"
                                                data-style="form-control">
                                            @forelse($wilayah as $w)
                                                <option value="{{ $w->id }}"
                                                        @if($project->wilayah_id == $w->id)
                                                        selected
                                                        @endif
                                                >{{ ucwords($w->name) }}</option>
                                            @empty
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <select class="select2 form-control" name="team_id" id="team_id"
                                            ...
                                            @forelse($team as $w)
                                                <option value="{{ $w->id }}"
                                                        @if($project->team_id == $w->id)
                                                        selected
                                                        @endif
                                                >{{ ucwords($w->team_name) }}</option>
                                            @empty
                                                <option value="">-</option>
                                            @endforelse
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label">Alert Kuning (dalam hari)</label>
                                        <input type="text" name="alert_kuning" class="form-control" value="{{$project->alert_late_yellow}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label class="control-label">Alert Merah (dalam hari)</label>
                                        <input type="text" name="alert_merah" class="form-control" value="{{$project->alert_late_red}}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
