                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control" name="subcompany_id" id="subcompany_id"
                                                data-style="form-control">
                                            @forelse($subcompany as $w)
                                                <option value="{{ $w->id }}">{{ ucwords($w->name) }}</option>
                                            @empty
                                                <option value="">-</option>
                                            @endforelse
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control" name="wilayah_id" id="wilayah_id"
                                                data-style="form-control">
                            ...
                            <div class="row">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control" name="team_id" id="team_id"
                                                data-style="form-control">
                                            @forelse($team as $w)
                                                <option value="{{ $w->id }}">{{ ucwords($w->team_name) }}</option>
                                            @empty
                                                <option value="">-</option>
                                            @endforelse
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alert_kuning" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alert_merah" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
