    ...
    <div class="row bg-title">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('admin.cabang.index') }}">{{ $pageTitle }}</a></li>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-inverse">
                <div class="panel-heading">@lang('app.update') @lang('app.menu.cabang')</div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <label for="company_name">@lang('app.menu.cabang')</label>
                                    <input type="text" class="form-control" id="cabang_name" name="cabang_name" value="{{ $cabang->name }}">
                                </div>
                            ...
                            @forelse($cabang->members as $member)
                                    <div class="row">
...
@push('footer-script')
    ...
    <script>
        ...
        $('#save-form').click(function () {
            $.easyAjax({
                url: '{{route('admin.cabang.update', [$cabang->id])}}',
