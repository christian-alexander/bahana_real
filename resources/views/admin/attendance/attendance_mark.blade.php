                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group bootstrap-timepicker timepicker">
                                                ...
                                                <input type="text" name="clock_in_time"
                                                       ...
                                                       @if(!is_null($row->clock_in_time)) value="{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->clock_in_time)->timezone($timezone)->format($global->time_format) }}" @endif>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group bootstrap-timepicker timepicker">
                                                ...
                                                <input type="text" name="clock_out_time" id="clock-out"
                                                       ...
                                                       @if(!is_null($row->clock_out_time)) value="{{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $row->clock_out_time)->timezone($timezone)->format($global->time_format) }}" @endif>
                                            </div>
                                        </div>
