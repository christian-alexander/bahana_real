...
@section('page-title')
    <div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title"><i class="{{ $pageIcon }}"></i> Laporan Tugas</h4>
...
<script>
    ...
    $('body').on('click', '.sa-params', function(){
        ...
        swal({
            title: "Are you sure?",
            text: "You will not be able to recover the deleted Laporan Tugas!",
    ...
    $('body').on('click', '.edit-time-log', function () {
        ...
        $('#modelHeading').html('Update Laporan Tugas');
        // $('#modelHeading').html('Update Time Log');
        $.ajaxModal('#editTimeLogModal', url);

    });
    $('body').on('click', '.accept-time-log', function () {
        var id = $(this).data('time-id');
        swal({
            title: "Are you sure?",
            ...
            if (isConfirm) {
                ...
                var url = '{{ route('admin.time-logs.approve', ':id')}}';
                url = url.replace(':id', id);
    ...
    $('body').on('click', '.reject-time-log', function () {
        var id = $(this).data('time-id');

        var url = '{{ route('admin.time-logs.reject-reason', ':id')}}';
        url = url.replace(':id', id);

        $('#modelHeading').html('Reject Laporan Tugas');
        // $('#modelHeading').html('Reject Time Log');
        $.ajaxModal('#editTimeLogModal', url);
    });
