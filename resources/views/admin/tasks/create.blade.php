                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox checkbox-info">
                                                <input id="interval_report-task" name="interval_report_check" value="true" type="checkbox">
                                    ...
                                    <div class="col-md-4" id="interval-field">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="interval_report" id="interval_report" class="form-control" autocomplete="off" value="0">
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox checkbox-info">
                                                <input id="is_requires_gps-task" name="is_requires_gps" value="true"
                                                       ...
                                                       type="checkbox">
                                                <label for="is_requires_gps-task">@lang('modules.tasks.isRequiresGPS') <a
                                                            class="mytooltip font-12" href="javascript:void(0)"> <i
                                                                class="fa fa-info-circle"></i><span
                                                                class="tooltip-content5"><span
                                                                    class="tooltip-text3"><span
                                                                        class="tooltip-inner2">@lang('modules.tasks.GPSInfo')</span></span></span></a></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox checkbox-info">
                                                <input id="is_requires_camera-task" name="is_requires_camera" value="true"
                                                       ...
                                                       type="checkbox">
                                                <label for="is_requires_camera-task">@lang('modules.tasks.isRequiresCamera') <a
                                                            class="mytooltip font-12" href="javascript:void(0)"> <i
                                                                class="fa fa-info-circle"></i><span
                                                                class="tooltip-content5"><span
                                                                    class="tooltip-text3"><span
                                                                        class="tooltip-inner2">@lang('modules.tasks.CameraInfo')</span></span></span></a></label>
                                            </div>
                                        </div>
                                    </div>
