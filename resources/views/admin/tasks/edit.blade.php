                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox checkbox-info">
                                        <input id="is_requires_gps-task" name="is_requires_gps" value="true"
                                        @if ($task->is_requires_gps)
                                            checked
                                        @endif
                                               type="checkbox">
                                        <label for="is_requires_gps-task">@lang('modules.tasks.isRequiresGPS') <a class="mytooltip font-12" href="javascript:void(0)"> <i class="fa fa-info-circle"></i><span class="tooltip-content5"><span class="tooltip-text3"><span class="tooltip-inner2">@lang('modules.tasks.GPSInfo')</span></span></span></a></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox checkbox-info">
                                        <input id="is_requires_camera-task" name="is_requires_camera" value="true"
                                        @if ($task->is_requires_camera)
                                            checked
                                        @endif
                                               type="checkbox">
                                        <label for="is_requires_camera-task">@lang('modules.tasks.isRequiresCamera') <a class="mytooltip font-12" href="javascript:void(0)"> <i class="fa fa-info-circle"></i><span class="tooltip-content5"><span class="tooltip-text3"><span class="tooltip-inner2">@lang('modules.tasks.CameraInfo')</span></span></span></a></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="checkbox checkbox-info">
                                        <input id="interval_report-task" name="interval_report_check" value="true"
                                        @if ($task->interval_report)
                                            checked
                                        @endif
                                               type="checkbox">
                                        <label for="interval_report-task">@lang('modules.tasks.isIntervalReport') <a class="mytooltip font-12" href="javascript:void(0)"> <i class="fa fa-info-circle"></i><span class="tooltip-content5"><span class="tooltip-text3"><span class="tooltip-inner2">@lang('modules.tasks.IntervalReportInfo')</span></span></span></a></label>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4" id="interval-field">
                                <div class="form-group">

                                    <label class="control-label">@lang('modules.tasks.IntervalTimeLabel')</label>
                                    <input type="text" name="interval_report" id="interval_report" class="form-control" autocomplete="off" value="{{ $task->interval_report }}">
                                </div>
                            </div>
                                    ...
                                    {{-- <select class="select2 select2-multiple " multiple="multiple"
                                        ...
                                        @if(is_null($task->project_id))
                                            @foreach($employees as $member)
                                                <option value="{{ $member->id }}" {{$member->id==$task->assignee_user_id?'selected':''}}>{{ $member->name }}</option>
                                            @endforeach
...
<script>
    function check_interval(){
        var interval_report = $("#interval_report-task").is(":checked");

        if(!interval_report){
            $("#interval-field").css("visibility", "hidden");
        }else{
            $("#interval-field").css("visibility", "visible");
        }
    }
    ...
    $(document).ready(function(){
        ...
        check_interval();
        $("#interval_report-task").click(function(e){
            check_interval();
        });
    });
</script>
