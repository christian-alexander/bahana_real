                ...
                <div class="row">
                    @forelse($pendingLeaves as $key=>$pendingLeave)
                        <div class="col-md-3 m-b-25">
                            ...
                            @php
                                $leavesRemaining = ($pendingLeave->no_of_leaves);
                                // $leavesRemaining = ($pendingLeave->no_of_leaves-$pendingLeave->leaves_taken_count);
                                $percentLeavesRemaining = ($leavesRemaining/$pendingLeave->no_of_leaves) * 100;
                            @endphp
