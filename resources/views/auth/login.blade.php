    ...
    <form class="form-horizontal form-material" id="loginform" action="{{ route('login') }}" method="POST">
        ...
        <div class="form-group">
            <div class="col-md-12">
                ...
                <a href="{{ route('password.request') }}"  class="text-dark pull-right"><i class="fa fa-lock m-r-5"></i> Lupa Password?</a> </div>
        </div>
        ...
        <?php
            $getSetting = \DB::table('global_settings')->first();
        ?>
        @if ($getSetting->show_signup==1)
