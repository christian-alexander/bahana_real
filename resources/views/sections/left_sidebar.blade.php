<?php
    // get setting
    $global_setting = DB::table('global_settings')->first();
?>
    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
                ...
                <li><a href="{{ route('admin.employees.index') }}" class="waves-effect"><i class="ti-user"></i> <span class="hide-menu"> @lang('app.menu.hr') <span class="fa arrow"></span> </span></a>
                    <ul class="nav nav-second-level">
                        @if(in_array('employees',$modules))
                            ...
                            @if($user->is_admin_office == "0") 
                                <li><a href="{{ route('admin.subcompany.index') }}">@lang('app.menu.subcompany')</a></li>
                                <li><a href="{{ route('admin.cabang.index') }}">@lang('app.menu.cabang')</a></li>
                                <li><a href="{{ route('admin.wilayah.index') }}">@lang('app.menu.wilayah')</a></li>
                                ...
                                <li><a href="{{ route('admin.cluster-working-hour.index') }}">@lang('app.menu.cluster_working_hour')</a></li>
                            @endif

                        @endif
                        @if(in_array('attendance',$modules))
                            <li><a href="{{ route('admin.attendances.laporanKehadiran') }}" class="waves-effect">@lang('app.menu.attendance')</a> </li>
                        @endif
            ...
            @if($user->is_admin_office == "0") 
                ...
                {{-- @if(in_array("office", $modules)) --}}
                    <li><a href="{{ route('admin.office.index') }}" class="waves-effect"><i class="icon-layers"></i> <span class="hide-menu">@lang('app.menu.office') </span></a> </li>
                    <li><a href="{{ route('admin.kapal.index') }}" class="waves-effect"><i class="icon-layers"></i> <span class="hide-menu">Kapal </span></a> </li>
                    
                    <li><a href="{{ route('admin.schedulekapal.index') }}" class="waves-effect"><i class="icon-layers"></i> <span class="hide-menu">Schedule Kapal </span></a> </li>
                    <li><a href="{{ route('admin.pertanyaan.index') }}" class="waves-effect"><i class="icon-layers"></i> <span class="hide-menu">@lang('app.menu.pertanyaan') </span></a> </li>
                    {{-- <li><a href="{{ route('admin.form-builder.index') }}" class="waves-effect"><i class="icon-layers"></i> <span class="hide-menu">Form Builder </span></a> </li> --}}
                    <li><a href="{{ route('admin.tipe-cuti.index') }}" class="waves-effect"><i class="icon-layers"></i> <span class="hide-menu">Tipe Cuti </span></a> </li>
                {{-- @endif --}}
                ...
                @if(in_array("notices", $modules))
                    ...
                    @endif
                <li><a href="{{ route('admin.assets.index') }}" class="waves-effect"><i class="ti-layout-media-overlay"></i> <span class="hide-menu">Assets </span></a> </li>
            @endif
            ...
            <li><a href="{{ route('admin.reports.index') }}" class="waves-effect"><i class="ti-pie-chart"></i> <span class="hide-menu"> @lang('app.menu.reports') <span class="fa arrow"></span> </span></a>
                <ul class="nav nav-second-level">
                    ...
                    @else
                        {{-- <li><a href="{{ route('admin.leave-report.index') }}">@lang('app.menu.leaveReport')</a></li> --}}
                        <li><a href="{{ route('admin.attendance-report.index') }}">@lang('app.menu.attendanceReport')</a></li>
                        <li><a href="{{ route('admin.task-report.leadtime-pengecekan-tugas') }}">Laporan Leadtime Pengecekan Tugas</a></li>
                        <li><a href="{{ route('admin.report.tracker.index') }}">Laporan Tracking</a></li>
                        @if($user->is_admin_office == "0") <li><a href="{{ route('admin.spk.index') }}">Laporan Surat Permintaan Kapal</a></li> @endif
                    @endif
                </ul>
            </li>
            @endif
            ...
            @if($user->is_admin_office == "0")
                ...
                @else        
                    <li class="pb-30"><a href="{{ route('admin.general-settings.index') }}" class="waves-effect"><i class="ti-settings"></i> <span class="hide-menu"> @lang('app.menu.settings')</span></a>
                @endif
                </li>
            @endif
