    ...
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        ...
        <ul class="nav" id="side-menu">
            ...
            @foreach ($worksuitePlugins as $item)
                ...
                @endif
            @endforeach
			@if ($user->employeeDetail->is_hrd_kapal==1 || $user->employeeDetail->is_pc == 1)
                <li><a href="{{ route('member.abk.index') }}" class="waves-effect"><i class="icon-user"></i> <span class="hide-menu">ABK Kapal </span></a> </li>

                <li><a href="{{ route('member.kapal.index') }}" class="waves-effect"><i class="icon-layers"></i> <span class="hide-menu">Kapal </span></a> </li>
                
                <li><a href="{{ route('member.schedulekapal.index') }}" class="waves-effect"><i class="icon-layers"></i> <span class="hide-menu">Schedule Kapal </span></a> </li>
            @endif
