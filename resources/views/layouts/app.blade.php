...
<head>
    ...
    @endif
  	...
  	<script>
  		let is_admin_office = {{ $user->is_admin_office }};
      	let admin_subcompany = {{ $employee_detail->sub_company_id }};
  	</script>
    ...
    @endif
    <style>
        #sticky-note-header, #sticky-note-toggle{
            display: none;
        }
    </style>
  ...
  <body class="fix-sidebar <?php if($user->is_admin_office == "1"){ echo 'is_admin_office'; } ?> ">
<!-- Preloader -->
<div class="preloader">
