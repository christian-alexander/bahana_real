/******/ (() => { // webpackBootstrap
/*!*******************************************!*\
  !*** ./public/vendor/signature/js/app.js ***!
  \*******************************************/
var wrapper = document.getElementById("signature-pad");
var clearButton = wrapper.querySelector("[data-action=clear]"); // var changeColorButton = wrapper.querySelector("[data-action=change-color]");
...
$("#submitBtn").on('click', function (e) {
  var dataURL = signaturePad.toDataURL(); // dataURL = Base64.encode(dataURL);
