...
/***/ "./public/iframe/assets/plugins/custom/gmaps/gmaps.js":
/*!************************************************************!*\
  !*** ./public/iframe/assets/plugins/custom/gmaps/gmaps.js ***!
  \************************************************************/
...
(function (root, factory) {
  if (( false ? 0 : _typeof(exports)) === 'object') {
    ...
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [Object(function webpackMissingModule() { var e = new Error("Cannot find module 'jquery'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), Object(function webpackMissingModule() { var e = new Error("Cannot find module 'googlemaps!'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
  ...
  GMaps.prototype.addLayer = function (layerName, options) {
    ...
    switch (layerName) {
      ...
      case 'places':
        this.singleLayers.places = layer = new google.maps.places.PlacesService(this.map); //search, nearbySearch, radarSearch callback, Both are the same
...
/******/ 	__webpack_require__("./public/iframe/assets/plugins/custom/gmaps/gmaps.js");
/******/ })()
;