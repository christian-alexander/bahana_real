...
class CreateFormkasbonsementarasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('form_kasbon_sementara', function (Blueprint $table) {
            ...
            $table->string('deadline_ptj')->nullable();
    ...
    {
        Schema::dropIfExists('form_kasbon_sementara');
    }
}
