@forelse($asset->history as $history)
    <div class="row m-b-5 font-12" id="asset-history-{{$history->id}}">
        ...
        <div class="col-xs-12  m-b-10">
            <div class="col-xs-3">
                <span class="text-dark font-12">Repeat notification</span>
            </div>
            <div class="col-xs-9">
                <span class="text-muted font-12">{{ is_null($history->repeat_notification) ? '-' : $history->repeat_notification }}</span>
            </div>
        </div>
        ...
        <div class="col-xs-12  m-b-10">
            <div class="col-xs-3">
                <span class="text-dark font-12">Qty</span>
            </div>
            <div class="col-xs-9">
                <span class="text-muted font-12">{{ is_null($history->qty) ? '-' : $history->qty }}</span>
            </div>
        </div>
