        ...
        <div class="form-body">
                ...
                <div class="col-xs-6">
                    <div class="form-group">
                        <div class="form-group">
                            ...
                            <input type="text" name="qty" id="qty" class="form-control" value="{{ $history->qty ? $history->qty : '' }}">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-6">
                    <div class="form-group">
                        <div class="form-group">
                            <label class="control-label">Notify lender</label>
                ...
                <div class="col-xs-6 ">
                    <div class="form-group">
                        ...
                        <select class="select2 form-control" name="repeat_notification" id="repeat_notification" data-style="form-control">
                            <option value="norepeat" @if($history->repeat_notification == "norepeat") selected @endif>No Repeat</option>
                            <option value="daily" @if($history->repeat_notification == "daily") selected @endif>Daily</option>
                            <option value="monthly" @if($history->repeat_notification == "monthly") selected @endif>Monthly</option>
                            <option value="yearly" @if($history->repeat_notification == "yearly") selected @endif>Yearly</option>
                        </select>
                    </div>
                </div>
                <div class="col-xs-6">
