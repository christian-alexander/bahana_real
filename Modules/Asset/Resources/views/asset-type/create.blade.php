<div class="modal-header">
    ...
    <h4 class="modal-title">@lang('asset::app.assetType')</h4>
</div>
...
<script>
    ...
    $('.delete-category').click(function () {
        ...
        var url = "{{ route('admin.asset-type.destroy',':id') }}";
        ...
        $.easyAjax({
            ...
            success: function (response) {
                if (response.status == "success") {
                    ...
                    $('#asset_type_id').html(options);
                    $('#asset_type_id').find('select').select2();
                }
            }
        });
    });
    ...
    $('#save-category').click(function () {
        $.easyAjax({
            url: '{{route('admin.asset-type.store')}}',
