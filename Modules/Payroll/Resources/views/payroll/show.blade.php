            ...
            <div class="row">
                ...
                @if ($user->hasRole('admin'))
                    <div class="col-sm-4 text-right">
                        <a href="{{ route('admin.payroll.downloadPdf', $salarySlip->id) }}" class="btn btn-success  btn-sm"><i class="fa fa-download"></i> @lang('app.download')</a>&nbsp;
                        <a href="{{ route('admin.payroll.edit', $salarySlip->id) }}" class="btn btn-info  btn-sm"><i class="fa fa-edit"></i> @lang('app.edit')</a>&nbsp;
                    </div>                    
                @else
                    <div class="col-sm-4 text-right">
                        <a href="{{ route('member.payroll.downloadPdf', $salarySlip->id) }}" class="btn btn-success btn-sm"><i class="fa fa-download"></i> @lang('app.download')</a>&nbsp;
                    </div> 
                @endif
                <div class="col-sm-12">
